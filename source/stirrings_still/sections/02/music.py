...
def V1(voice, time_signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(8, 11), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(27, 28), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(31), head=voice.get_name())
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(43), head=voice.get_name())
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        time_signatures(44),
        "C",
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(45), head=voice.get_name())
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        time_signatures(46),
        "C",
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(47), head=voice.get_name())
    voice.extend(music)
    music = library.make_urtext_field_rhythm(time_signatures(48))
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(49), head=voice.get_name())
    voice.extend(music)
    music = library.make_trajectory_rhythm(
    ...
    voice.extend(music)
    music = baca.make_mmrests(time_signatures(66), head=voice.get_name())
    voice.extend(music)
    ...
    with baca.scope(m.get(50, 60)) as o:
        with baca.scope(o.rleaves()) as u:
            ...
            baca.spanners.scp(
                baca.select.mgroups(u, [2, 4, 5]),
                "P poss. =| P molto -> T =|",
                baca.tweak.bound_details_right_padding(2.25, i=0),
...
def v2(cache, time_signatures):
    ...
    with baca.scope(m.get(18, 27)) as o:
        baca.spanners.tasto(
            o,
            baca.tweak.staff_padding(4 + 6.5 + 2.5),
            rleak=True,
        )
    with baca.scope(m[26]) as o:
        baca.glissando(
...
def make_layout(environment):
    ...
    spacing = baca.layout.Spacing(
        default=(1, 20),
        strict_overrides=(
            baca.layout.Override(26, (1, 48)),
            baca.layout.Override(45, (1, 48)),
            baca.layout.Override(64, (1, 32)),
            baca.layout.Override([28, 66], (1, 288)),
        ),
    )
