...
spacing = baca.make_layout(
    ...
    baca.page(
        3,
        baca.system(measure=18, y_offset=first_system_y_offset, distances=distances),
    ),
    ...
    baca.page(
        5,
        baca.system(measure=29, y_offset=first_system_y_offset, distances=distances),
    ),
    ...
    baca.page(
        9,
        baca.system(measure=64, y_offset=first_system_y_offset, distances=distances),
    ),
...
if __name__ == "__main__":
    baca.build.make_layout_ly(spacing, curtail_measure_count=63)
