...
%@% ^ \markup \baca-dark-cyan-markup (599)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
%@% ^ \markup \baca-dark-cyan-markup <0>                                           %! MEASURE_INDEX_MARKUP:_label_measure_indices(2)
%@% ^ \markup \baca-dark-cyan-markup ((1))                                         %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% ^ \markup \baca-dark-cyan-markup [L.1]                                         %! _label_stage_numbers:STAGE_NUMBER_MARKUP
    ^ \markup { [L.1] }                                                            %! IndicatorCommand
%@% ^ \markup \baca-dark-cyan-markup "[25'19'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup (600)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
%@% ^ \markup \baca-dark-cyan-markup <1>                                           %! MEASURE_INDEX_MARKUP:_label_measure_indices(2)
%@% ^ \markup \baca-dark-cyan-markup ((2))                                         %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% ^ \markup \baca-dark-cyan-markup [L.2]                                         %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[25'22'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 601 / measure 3]                                      %! _comment_measure_numbers
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (601)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
%@% ^ \markup \baca-dark-cyan-markup <2>                                           %! MEASURE_INDEX_MARKUP:_label_measure_indices(2)
%@% ^ \markup \baca-dark-cyan-markup ((3))                                         %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% ^ \markup \baca-dark-cyan-markup [L.3]                                         %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[25'27'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 602 / measure 4]                                      %! _comment_measure_numbers
    \time 5/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (602)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[25'32'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 603 / measure 5]                                      %! _comment_measure_numbers
    \time 6/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/2                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (603)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[25'39'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 604 / measure 6]                                      %! _comment_measure_numbers
    \time 3/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (604)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[25'46'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 605 / measure 7]                                      %! _comment_measure_numbers
    \time 4/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (605)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[25'50'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 606 / measure 8]                                      %! _comment_measure_numbers
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (606)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[25'55'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 607 / measure 9]                                      %! _comment_measure_numbers
    \time 5/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (607)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'00'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 608 / measure 10]                                     %! _comment_measure_numbers
    \time 6/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/2                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (608)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'06'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 609 / measure 11]                                     %! _comment_measure_numbers
    \time 3/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (609)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'14'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 610 / measure 12]                                     %! _comment_measure_numbers
    \time 4/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (610)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'17'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 611 / measure 13]                                     %! _comment_measure_numbers
    \time 3/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (611)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'22'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 612 / measure 14]                                     %! _comment_measure_numbers
    \time 4/4                                                                      %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (612)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'26'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 613 / measure 15]                                     %! _comment_measure_numbers
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (613)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'31'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [L GlobalSkips measure 614 / measure 16]                                     %! _comment_measure_numbers
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (614)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'36'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
