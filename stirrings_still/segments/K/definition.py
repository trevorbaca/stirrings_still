...
maker(
    ...
    baca.new(
        ...
        baca.text_spanner(
            ...
            final_piece_spanner=False,
            lilypond_id=1,
            piece_selector=baca.cmgroups([1, 1, 1, 1, 2, 1]),
            selector=baca.leaves().rleak(),
            ),
        baca.text_spanner(
            'T -> P ->',
...
maker(
    ...
    baca.new(
        ...
        baca.text_spanner(
            ...
            final_piece_spanner=False,
            lilypond_id=1,
            piece_selector=baca.cmgroups([1, 2, 1, 1, 1, 1]),
            selector=baca.leaves().rleak(),
            ),
        baca.text_spanner(
            'T -> P ->',
...
maker(
    ...
    baca.new(
        ...
        baca.text_spanner(
            ...
            final_piece_spanner=False,
            lilypond_id=1,
            piece_selector=baca.cmgroups([1, 1, 2, 1, 1, 1]),
            selector=baca.leaves().rleak(),
            ),
        baca.text_spanner(
            'T -> P ->',
...
maker(
    ...
    baca.new(
        ...
        baca.text_spanner(
            ...
            final_piece_spanner=False,
            lilypond_id=1,
            piece_selector=baca.cmgroups([1, 1, 1, 2, 1, 1]),
            selector=baca.leaves().rleak(),
            ),
        baca.text_spanner(
            'T -> P ->',
