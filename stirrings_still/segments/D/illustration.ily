...
D_GlobalSkips = {                                                              %! extern
    ...
    %@% ^ \baca-dark-cyan-markup "[9'17'']"                                    %! CLOCK_TIME_MARKUP:_label_clock_time
        \once \override Score.BarLine.extra-offset = #'(-1.5 . 0)              %! baca_bar_line_extra_offset:OverrideCommand(1)
        \once \override Score.SpanBar.extra-offset = #'(-1.5 . 0)              %! baca_span_bar_extra_offset:OverrideCommand(1)
...
%@% \override Staff.Clef.color = ##f                                           %! REAPPLIED_CLEF_COLOR_CANCELLATION:_attach_color_literal(1)
    ...
    \override NoteHead.X-extent = ##f                                          %! baca_note_head_x_extent_false:OverrideCommand(1)
    \baca-unpitched-music-warning                                              %! _color_unpitched_notes
    c'4                                                                        %! stirrings_still_strokes
    - \abjad-zero-padding-glissando                                            %! baca_glissando:SpannerCommand
    \glissando                                                                 %! baca_glissando:SpannerCommand
    ...
    \times 1/1 {                                                               %! stirrings_still_accelerando
        ...
        - \abjad-dashed-line-with-hook                                         %! baca_text_spanner:PiecewiseCommand(1)
        - \baca-text-spanner-left-text "fast whisked ellipses"                 %! baca_text_spanner:PiecewiseCommand(1)
    ...
    - \abjad-dashed-line-with-hook                                             %! baca_text_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-text "8˝ cir."                                   %! baca_text_spanner:PiecewiseCommand(1)
    - \tweak bound-details.right.padding #3.25                                 %! baca_text_spanner:PiecewiseCommand(1)
    - \tweak staff-padding #5                                                  %! baca_text_spanner:PiecewiseCommand(1)
    \startTextSpan                                                             %! baca_text_spanner:PiecewiseCommand(1)
    - \abjad-dashed-line-with-hook                                             %! baca_text_spanner:PiecewiseCommand(1)
    - \baca-text-spanner-left-text "golden tone"                               %! baca_text_spanner:PiecewiseCommand(1)
    - \tweak bound-details.right.padding #3.25                                 %! baca_text_spanner:PiecewiseCommand(1)
    - \tweak staff-padding #9                                                  %! baca_text_spanner:PiecewiseCommand(1)
    \startTextSpanOne                                                          %! baca_text_spanner:PiecewiseCommand(1)
