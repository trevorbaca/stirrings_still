...
maker(
    ('vc', 57),
    baca.generalized_hairpin('pp <| mf', selector=baca.leaves()),
    baca.markup(
        'HAND!',
...
maker(
    ('tutti', (58, 63)),
    baca.generalized_hairpin('mf >o niente'),
    baca.text_spanner(
...
maker(
    ...
    baca.map(
        ...
        baca.generalized_hairpin('niente o< p'),
        ),
# TODO:
#    baca.measures(
#        (86, 89),
#        baca.generalized_hairpin('p < fff'),
#        ),
    baca.markup(
