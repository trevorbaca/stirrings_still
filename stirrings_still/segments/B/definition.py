...
maker(
    (['v1', 'v2'], (6, 7)),
    baca.generalized_hairpin('mf >o niente', selector=baca.leaves()),
    )
...
maker(
    ('va', 6),
    baca.generalized_hairpin('niente o< p', selector=baca.rleaves()),
    )
...
maker(
    ('vc', (6, 9)),
    baca.generalized_hairpin('niente o< f', selector=baca.rleaves()),
    )
