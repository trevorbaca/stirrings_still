G_GlobalRests = {
    ...
    % [G GlobalRests measure 217]                                        %! SM4
    R1 * 15/16
    
    % [G GlobalRests measure 218]                                        %! SM4
    \once \override Score.MultiMeasureRest.transparent = ##t             %! GFC2
    \once \override Score.TimeSignature.stencil = ##f                    %! GFC2
    R1 * 1/4
    ^ \markup {                                                          %! GFC1
...
%@% \override Staff.Clef.color = ##f                             %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
    ...
    % [G ViolinIMusicVoice measure 217]                          %! SM4
    R1 * 15/16
    
    % [G ViolinIMusicVoice measure 218]                          %! SM4
    R1 * 1/4
...
%@% \override Staff.Clef.color = ##f                             %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
    ...
    % [G ViolinIIMusicVoice measure 217]                         %! SM4
    R1 * 15/16
    
    % [G ViolinIIMusicVoice measure 218]                         %! SM4
    R1 * 1/4
...
%@% \override Staff.Clef.color = ##f                             %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
    ...
    % [G ViolaMusicVoice measure 217]                            %! SM4
    R1 * 15/16
    
    % [G ViolaMusicVoice measure 218]                            %! SM4
    R1 * 1/4
...
%@% \override Staff.Clef.color = ##f                             %! SM7:REAPPLIED_CLEF_COLOR_CANCELLATION:SM37
    ...
    % [G CelloMusicVoice measure 217]                            %! SM4
    R1 * 15/16
    
    % [G CelloMusicVoice measure 218]                            %! SM4
    R1 * 1/4
