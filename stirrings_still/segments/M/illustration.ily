...
%@% ^ \markup \baca-dark-cyan-markup (615)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'41'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
%@% - \abjad_invisible_line                                                        %! _attach_metronome_marks(2)
%@% - \tweak bound-details.left.text \markup {                                     %! _attach_metronome_marks(2)
%@%     \concat                                                                    %! _attach_metronome_marks(2)
%@%         {                                                                      %! _attach_metronome_marks(2)
%@%             \abjad-metronome-mark-markup #2 #0 #1 #"48"                        %! _attach_metronome_marks(2)
        ...
        \concat                                                                    %! _attach_metronome_marks(3)
            {                                                                      %! _attach_metronome_marks(3)
                \with-color                                                        %! _attach_metronome_marks(3)
                    ...
                    \abjad-metronome-mark-markup #2 #0 #1 #"48"                    %! _attach_metronome_marks(3)
...
%@% ^ \markup \baca-dark-cyan-markup (616)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
%@% ^ \markup \baca-dark-cyan-markup <1>                                           %! MEASURE_INDEX_MARKUP:_label_measure_indices(2)
%@% ^ \markup \baca-dark-cyan-markup ((2))                                         %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% ^ \markup \baca-dark-cyan-markup [M.2]                                         %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[26'44'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 617 / measure 3]                                      %! _comment_measure_numbers
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (617)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
%@% ^ \markup \baca-dark-cyan-markup <2>                                           %! MEASURE_INDEX_MARKUP:_label_measure_indices(2)
%@% ^ \markup \baca-dark-cyan-markup ((3))                                         %! LOCAL_MEASURE_NUMBER_MARKUP:_label_measure_indices(3)
%@% ^ \markup \baca-dark-cyan-markup [M.3]                                         %! _label_stage_numbers:STAGE_NUMBER_MARKUP
%@% ^ \markup \baca-dark-cyan-markup "[26'47'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 618 / measure 4]                                      %! _comment_measure_numbers
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (618)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'51'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup (619)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'55'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup (620)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[26'57'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 621 / measure 7]                                      %! _comment_measure_numbers
    s1 * 7/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (621)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'02'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% ^ \markup \baca-dark-cyan-markup (622)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'06'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 623 / measure 9]                                      %! _comment_measure_numbers
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (623)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'11'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 624 / measure 10]                                     %! _comment_measure_numbers
    \time 8/16                                                                     %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (624)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'16'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 625 / measure 11]                                     %! _comment_measure_numbers
    \time 12/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (625)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'19'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 626 / measure 12]                                     %! _comment_measure_numbers
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (626)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'22'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 627 / measure 13]                                     %! _comment_measure_numbers
    \time 16/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (627)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'26'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 628 / measure 14]                                     %! _comment_measure_numbers
    \time 14/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 7/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (628)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'31'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 629 / measure 15]                                     %! _comment_measure_numbers
    s1 * 7/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (629)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'36'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 630 / measure 16]                                     %! _comment_measure_numbers
    \time 16/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (630)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'40'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 631 / measure 17]                                     %! _comment_measure_numbers
    \time 12/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (631)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'45'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 632 / measure 18]                                     %! _comment_measure_numbers
    \time 10/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (632)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'49'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 633 / measure 19]                                     %! _comment_measure_numbers
    \time 16/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (633)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'52'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 634 / measure 20]                                     %! _comment_measure_numbers
    s1 * 1                                                                         %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (634)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[27'57'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 635 / measure 21]                                     %! _comment_measure_numbers
    \time 14/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 7/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (635)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'02'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 636 / measure 22]                                     %! _comment_measure_numbers
    s1 * 7/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (636)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'06'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 637 / measure 23]                                     %! _comment_measure_numbers
    \time 10/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (637)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'11'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 638 / measure 24]                                     %! _comment_measure_numbers
    \time 12/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (638)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'14'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 639 / measure 25]                                     %! _comment_measure_numbers
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (639)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'17'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 640 / measure 26]                                     %! _comment_measure_numbers
    \time 8/16                                                                     %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (640)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'21'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 641 / measure 27]                                     %! _comment_measure_numbers
    \time 12/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (641)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'24'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 642 / measure 28]                                     %! _comment_measure_numbers
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (642)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'27'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 643 / measure 29]                                     %! _comment_measure_numbers
    \time 10/16                                                                    %! EXPLICIT_TIME_SIGNATURE:_set_status_tag:_make_global_skips(2)
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 5/8                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (643)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'31'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
...
%@% \startTextSpan                                                                 %! _attach_metronome_marks(2)
    ...
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (644)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'34'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    
    % [M GlobalSkips measure 645 / measure 31]                                     %! _comment_measure_numbers
    s1 * 3/4                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (645)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'38'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
    \stopTextSpan                                                                  %! _attach_metronome_marks(1)
%@% - \abjad_invisible_line                                                        %! _attach_metronome_marks(2)
%@% - \tweak bound-details.left.text \markup {                                     %! _attach_metronome_marks(2)
%@%     \concat                                                                    %! _attach_metronome_marks(2)
...
%@% \startTextSpan                                                                 %! _attach_metronome_marks(2)
    ...
    \baca_time_signature_color "blue"                                              %! EXPLICIT_TIME_SIGNATURE_COLOR:_attach_color_literal(2)
    s1 * 1/2                                                                       %! _make_global_skips(1)
%@% ^ \markup \baca-dark-cyan-markup (646)                                         %! MEASURE_NUMBER_MARKUP:_label_measure_indices(1)
...
%@% ^ \markup \baca-dark-cyan-markup "[28'43'']"                                   %! CLOCK_TIME_MARKUP:_label_clock_time
