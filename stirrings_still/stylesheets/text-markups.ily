...
stirrings-still-text-eight = \markup {
    ...
    place. Then disappeared again only to reappear again later at another place
    again.
    } }
...
stirrings-still-text-ten = \markup {
    ...
    merely waiting. Waiting to see if he would or would not. Leave him or not
    alone again waiting for nothing again. Seen always from behind withersoever
    he went.
    } }
...
stirrings-still-text-eleven = \markup {
    ...
    place blindly in the dark of night or day seeking the way out. A way out.
    To the roads. The back roads.
    } }
...
stirrings-still-text-thirteen = \markup {
    ...
    that the half-hour would not and half fearing that it would not. Similarly
    when the half-hour struck. Similarly when the cries a moment ceased. Or
    merely wondering.
    } }
...
stirrings-still-text-fifteen = \markup {
    ...
    other on the one. At rest after all they did.
    } }
...
stirrings-still-text-seventeen = \markup {
    ...
    strokes. The cries. The same as ever. Till so many strokes and cries since
    he was last seen that perhaps he would not be seen again.
    } }
...
stirrings-still-text-twenty = \markup {
    ...
    their whenceabouts that is of clock and cries the same was true that is no
    more to be determined now than as was only natural then. Bringing to bear
    on all this his remains of reason he sought help in the thought that his
    memory of indoors was perhaps at fault and found it
    } }
...
stirrings-still-text-twenty-one = \markup {
    ...
    not to hear to listen and set out to look about him. Result finally he was
    in a field of grass which went some way if nothing else to explain his
    tread and then a little later as if to make up for this some way to
    increase his trouble. For he could recall no field of grass from even the
    very heart of which no limit of any kind was to be discovered but always in
    some quarter or another some end in sight such as a fence or other manner
    of bourne from which to return. Nor on his looking more closely to make
    matters worse was this the short green grass he seemed to remember eaten
    down by flocks and herds but long and light grey in color verging here and
    there on white. Then he sought help in the thought that his memory of
    outdoors was perhaps at fault and found it of none.
    } }
...
stirrings-still-text-twenty-three = \markup {
    ...
    and here that mising word again it were to end where never
    } }
