...
def V1(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(9, 11), head=voice.name)
    voice.extend(music)
...
def VA(voice, signatures):
    music = baca.make_repeat_tied_notes(signatures(1, 10), do_not_rewrite_meter=True)
    voice.extend(music)
...
def v1(cache):
    ...
    with baca.scope(m.get(1, 8)) as o:
        baca.hairpin(
            ...
            the_pieces=baca.select.mgroups(o.rleaves(), [1, 2, 1, 2, 1, 2]),
        )
        baca.markup(
            o.pleaf(0),
...
def v2(cache):
    ...
    with baca.scope(m.get(1, 8)) as o:
        baca.hairpin(
            o.rleaves(),
            "pp < f > pp < f > pp < f >o niente",
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 1, 2, 1, 1, 2]),
        )
        baca.markup(
            o.pleaf(0),
...
def vc(cache):
    ...
    with baca.scope(m.get(1, 8)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "(p) < ff -- (ff) >o niente",
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 4, 2 + 1]),
        )
        library.clouded_pane_spanner(
            o.rleaves(),
