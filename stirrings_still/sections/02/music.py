...
commands(
    ...
    baca.markup(
        ...
        abjad.Tweak(r"- \tweak extra-offset #'(4 . -30)"),
        selector=lambda _: baca.select.skip(_, 66 - 1),
    ),
)

commands(
    "Skips",
    baca.close_volta(lambda _: baca.select.skip(_, 32 - 1)),
)

skips = score["Skips"]

baca.commands._open_volta(skips[29 - 1], commands.first_measure_number)
