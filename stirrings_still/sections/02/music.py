...
def V1(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(8, 11), head=voice.name)
    voice.extend(music)
    ...
    voice.extend(music)
    music = library.make_clocktick_rhythm(signatures(14))
    voice.extend(music)
    ...
    voice.extend(music)
    music = library.make_declamation_rhythm(signatures(26))
    voice.extend(music)
    music = baca.make_mmrests(signatures(27, 28), head=voice.name)
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(31), head=voice.name)
    voice.extend(music)
    music = library.make_rasp_rhythm(signatures(32, 33))
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(34, 35),
        "C",
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(43), head=voice.name)
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(44),
        "C",
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(45), head=voice.name)
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(46),
        "C",
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(47), head=voice.name)
    voice.extend(music)
    music = library.make_urtext_field_rhythm(signatures(48))
    voice.extend(music)
    music = baca.make_mmrests(signatures(49), head=voice.name)
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(50, 57),
        "C",
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(63), head=voice.name)
    voice.extend(music)
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(66), head=voice.name)
    voice.extend(music)
...
def V2(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(28), head=voice.name)
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(29, 30),
        "C",
...
def VC(voice, signatures):
    ...
    voice.extend(music)
    music = library.make_clouded_pane_rhythm(signatures(6, 11))
    voice.extend(music)
    music = library.make_circle_rhythm(
        signatures(12, 15),
        (1, 4),
    ...
    voice.extend(music)
    music = library.make_clouded_pane_rhythm(signatures(45))
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(46),
        "C",
    ...
    music = baca.make_mmrests(signatures(47), head=voice.name)
    voice.extend(music)
    music = library.make_clouded_pane_rhythm(signatures(48))
    voice.extend(music)
    music = baca.make_mmrests(signatures(49), head=voice.name)
    voice.extend(music)
    music = library.make_trajectory_rhythm(
    ...
    music = baca.make_mmrests(signatures(63), head=voice.name)
    voice.extend(music)
    music = library.make_clouded_pane_rhythm(signatures(64))
    voice.extend(music)
    music = library.make_grid_rhythm(
        signatures(65),
        rotation=-3,
...
def v1(cache):
    ...
    with baca.scope(m.get(12, 24)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "p -- (p) >o niente",
            the_pieces=baca.select.mgroups(o.rleaves(), [8, 5 + 1]),
        )
    ...
    with baca.scope(m.get(50, 60)) as o:
        with baca.scope(o.rleaves()) as u:
            baca.hairpin(
                ...
                "fff -- ff > ppp --",
                bookend=False,
                the_pieces=baca.select.mgroups(u, [2, 4, 5 + 1]),
            )
            baca.scp_spanner(
                u,
                "P poss. =| P molto -> T =|",
        ...
        with baca.scope(m.get(29, 30)) as o:
            ...
            if name == "v1":
                ...
                baca.scp_spanner(
                    ...
                    "T -> ord. =|",
                    abjad.Tweak(r"- \tweak staff-padding 13"),
                    the_pieces=baca.select.mgroups(leaves, [1, 1 + 1]),
                )
...
def v2(cache, signatures):
    ...
    with baca.scope(m.get(12, 27)) as o:
        baca.hairpin(
            ...
            "p -- (p) < mf -- !",
            abjad.Tweak(r"- \tweak to-barline ##t"),
            the_pieces=baca.select.mgroups(o.rleaves(), [6, 3, 5 + 1]),
        )
    with baca.scope(m.get(14, 15)) as o:
        baca.alternate_bow_strokes(o.pheads())
    with baca.scope(m.get(16, 17)) as o:
    ...
    with baca.scope(m.get(50, 57)) as o:
        with baca.scope(o.rleaves()) as u:
            baca.hairpin(
                ...
                "fff -- ff > ppp --",
                bookend=False,
                the_pieces=baca.select.mgroups(u, [2, 4, 2 + 1]),
            )
            baca.scp_spanner(
                u,
                "P poss. -> P molto -> T =|",
...
def va(cache):
    ...
    with baca.scope(m.get(12, 21)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "p-ancora -- (p) >o niente",
            the_pieces=baca.select.mgroups(o.rleaves(), [8, 2 + 1]),
        )
    m = cache["var"]
    ...
    with baca.scope(m.get(50, 59)) as o:
        with baca.scope(baca.select.rleak(baca.select.ltleaves(o))) as u:
            baca.hairpin(
                ...
                "fff -- ff > ppp --",
                bookend=False,
                the_pieces=baca.select.mgroups(u, [2, 4, 4 + 1]),
            )
            baca.scp_spanner(
                u,
                "P poss. -> P molto -> T =|",
...
def vc(cache):
    ...
    with baca.scope(m.get(6, 11)) as o:
        ...
        baca.hairpin(
            ...
            "o< f -- !",
            abjad.Tweak(r"- \tweak to-barline ##t"),
            the_pieces=baca.select.mgroups(o.rleaves(), [4, 2 + 1]),
        )
    ...
    with baca.scope(m.get(50, 60)) as o:
        baca.hairpin(
            ...
            "fff -- ff > ppp --",
            bookend=False,
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 4, 5 + 1]),
        )
    with baca.scope(m.get(50, 61)) as o:
        ...
        baca.scp_spanner(
            ...
            abjad.Tweak(rf"- \tweak staff-padding {4 + 6.5}"),
            library.left_broken_tasto_tweak(),
            the_pieces=baca.select.mgroups(leaves, [2, 4, 6 + 1]),
        )
        baca.tuplet_bracket_staff_padding(o, 1.5)
    with baca.scope(m.get(52, 55)) as o:
        library.multistage_leaf_glissando(
