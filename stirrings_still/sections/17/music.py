...
def V1(voice, signatures):
    ...
    voice.extend(music)
    music = baca.make_mmrests(signatures(72), head=voice.name)
    voice.extend(music)
    music = library.make_trajectory_rhythm(
        signatures(73, 92),
        "C",
...
def VA(voice, signatures):
    ...
    music = baca.make_mmrests(signatures(72), head=voice.name)
    voice.extend(music)
    music = baca.make_repeat_tied_notes(signatures(73, 92))
    voice.extend(music)
...
def VC(voice, signatures):
    ...
    music = baca.make_mmrests(signatures(72), head=voice.name)
    voice.extend(music)
    music = library.make_eighth_notes(signatures(73, 87))
    voice.extend(music)
    music = baca.make_repeat_tied_notes(signatures(88, 92))
    voice.extend(music)
...
def v1(cache):
    ...
    with baca.scope(m.get(10, 24)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< fff -- "fff" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [4, 4, 7 + 1]),
        )
    ...
    with baca.scope(m.get(28, 40)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< ff -- "ff" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [3, 4, 6 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -8, clt=True, staff_padding=3.5)
    ...
    with baca.scope(m.get(43, 52)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< f -- "f" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [3, 2, 5 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -8, clt=True, staff_padding=3.5)
    ...
    with baca.scope(m.get(55, 62)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< mf -- "mf" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 2, 4 + 1]),
        )
        baca.tuplet_bracket_down(o)
    ...
    with baca.scope(m.get(64, 68)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "o< mp -- mp >o !",
            the_pieces=baca.select.mgroups(o.rleaves(), [1, 1, 3 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -8, clt=True, staff_padding=4.5)
    with baca.scope(m.get(64, 68)) as o:
...
def v2(cache):
    ...
    with baca.scope(m.get(31, 37)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'ff -- "ff" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [4, 3 + 1]),
        ),
        baca.tuplet_bracket_down(o)
        library.bcps(o, -7, clt=True, staff_padding=3.5)
    ...
    with baca.scope(m.get(46, 50)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'f -- "f" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 3 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -7, clt=True, staff_padding=3.5)
...
def va(cache):
    ...
    with baca.scope(m.get(28, 37)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< ff -- "ff" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [3, 4, 3 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -6, clt=True, staff_padding=3.5)
    with baca.scope(m.get(31, 37)) as o:
    ...
    with baca.scope(m.get(43, 50)) as o:
        ...
        baca.hairpin(
            o,
            'o< f -- "f" >o !',
            the_pieces=baca.select.mgroups(o, [3, 2, 3 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -6, clt=True, staff_padding=3.5)
    with baca.scope(m.get(46, 50)) as o:
    ...
    with baca.scope(m.get(55, 60)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< mf -- "mf" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [2, 2, 2 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -6, clt=True, staff_padding=3.5)
    with baca.scope(m.get(57, 60)) as o:
    ...
    with baca.scope(m.get(64, 67)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            "o< mp -- mp >o !",
            the_pieces=baca.select.mgroups(o.rleaves(), [1, 1, 2 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -6, clt=True, staff_padding=3.5)
    with baca.scope(m.get(65, 67)) as o:
...
def vc(cache):
    ...
    with baca.scope(m.get(43, 50)) as o:
        ...
        baca.hairpin(
            o.rleaves(),
            'o< f -- "f" >o !',
            the_pieces=baca.select.mgroups(o.rleaves(), [3, 2, 3 + 1]),
        )
        baca.tuplet_bracket_down(o)
        library.bcps(o, -5, clt=True, staff_padding=3.5)
    with baca.scope(m.get(46, 50)) as o:
